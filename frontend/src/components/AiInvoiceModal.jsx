...
import AnimatedButton from "../assets/GeberateBtn/Gbtn";
      ...
      <div className={aiInvoiceModalStyles.modal}>
        ...
        <div className="mt-4">
          ...
          <textarea
            ...
            placeholder={`eq. A person wants a logo design for her organic brand "GreenVibe." Quoted for $120 for 2 logo options and final delivery in PNG and vector format`}
            rows={8}
