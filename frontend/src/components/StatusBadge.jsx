...
const StatusBadge = ({ status = "", size = "default", showIcon = true }) => {
  ...
  return (
    <div
      className={`inline-flex items-center ${sizeClasses[size]} rounded-full font-medium ${config.bg} ${config.text} ${config.border} transition-all duration-300
    ...
    >
      ...
      group-hover:opacity-5 transition-opactiy duration-300`}
      ></div>
