...
/* ---------- util ---------- */
// This fucntion generates an unique id
function uid() {
  try {
...
export default function CreateInvoice() {
  ...
  // Update the item quantity and description using index
  ...
  // Can remove the item using index
  ...
  async function handleSave() {
    ...
    try {
      ...
      const prepared = {
        ...
        notes: invoice.notes || "",
        localId: invoice.id,
      }; // Things that will be save in the backend 
      ...
      const endpoint =
        isEditing && invoice.id
          ...
          : `${API_BASE}/api/invoice`; //post route to create the invoice in the mongoDB
